...
export default function DashboardPage() {
    ...
    const trackerOverviews = trackers.map(tracker => {
    ...
    const overallCompletionData = [
        { name: 'Filled', value: trackerOverviews.reduce((sum, tracker) => sum + tracker.filledPercentage, 0) / trackers.length },
        { name: 'Empty', value: 100 - (trackerOverviews.reduce((sum, tracker) => sum + tracker.filledPercentage, 0) / trackers.length) }
    ]
